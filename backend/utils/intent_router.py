from backend.utils.app_finder import find_app
from backend.utils.memory import get_learned_actions
from backend.utils.normalize import normalize_text
from backend.utils.phrase_match import contains_phrase
from backend.utils.scenario_config import (
