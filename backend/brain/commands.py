...
from backend.system.closer import smart_close
from backend.utils.app_finder import find_app, find_start_app
from backend.utils.commands_config import COMMANDS
from backend.utils.normalize import normalize_text
from backend.utils.special_launchers import try_special_case_launch
...
def _load_aliases():
    ...
    aliases_path = os.path.join(BACKEND_DIR, "config", "aliases.json")
