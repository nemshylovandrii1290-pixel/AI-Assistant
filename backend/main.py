...
from backend.brain.ai import ask_ai, ask_gpt_stream, compose_assistant_reply
from backend.brain.commands import execute_action, execute_actions
from backend.brain.context_tracker import ContextTracker
from backend.brain.scenario_manager import ScenarioManager
from backend.utils.app_finder import ensure_app_index
...
from backend.voice.listen import AudioStream
from backend.voice.recognize import StreamingRecognizer, is_valid_text
from backend.voice.speak import StreamingSpeechPlayer, speak
