...
backendRoot = fso.GetParentFolderName(WScript.ScriptFullName)
projectRoot = fso.GetParentFolderName(backendRoot)
...
shell.Run Chr(34) & pythonwPath & Chr(34) & " -m backend.main", 0
